...
class SunriseSunsetService {
  ...
  Future<Map<String, dynamic>> getSunData(Position position) async {
    ...
    print('SunriseSunsetService: Requesting $url');
    
    final response = await http.get(Uri.parse(url));
    print('SunriseSunsetService: Response status: ${response.statusCode}');
    print('SunriseSunsetService: Response body: ${response.body}');
